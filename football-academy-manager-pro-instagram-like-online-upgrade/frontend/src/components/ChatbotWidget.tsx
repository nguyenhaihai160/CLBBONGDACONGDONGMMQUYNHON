  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-green-500 to-emerald-700 text-white shadow-2xl shadow-green-900/30 transition hover:scale-105 lg:bottom-7 lg:right-7"
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end bg-slate-950/35 p-3 backdrop-blur-sm sm:items-center sm:justify-end sm:p-6" onClick={() => setOpen(false)}>
          <section
          ...
          >
            <header className="bg-gradient-to-br from-slate-950 to-emerald-900 p-4 text-white">
            ...
            <div className="border-t bg-white p-3">
              ...
              <form onSubmit={submit} className="flex items-center gap-2">
                ...
                />
                <button type="submit" disabled={loading || !input.trim()} className="flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-950 text-white disabled:cursor-not-allowed disabled:bg-slate-300">
                  <Send size={18} />
                </button>
              </form>
            </div>
