...
export function InstallAppBanner() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-4 z-[80] mx-auto max-w-xl rounded-3xl border border-white/30 bg-slate-950/95 p-4 text-white shadow-2xl backdrop-blur app-safe-bottom sm:bottom-6">
      <div className="flex gap-3">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-green-500 text-slate-950">
          <Smartphone size={22} />
        </div>
        <div className="min-w-0 flex-1">
          ...
          {canInstallAndroid && (
            <button onClick={install} className="mt-3 inline-flex items-center gap-2 rounded-2xl bg-green-400 px-4 py-2 text-sm font-black text-slate-950 active:scale-[0.98]">
