...
export function Attendance() {
  ...
  return (
    <div className="space-y-5">
      ...
      {selectedClass && <div className="rounded-2xl bg-green-50 p-3 text-sm text-pitch">Đang điểm danh lớp: <b>{selectedClass.name}</b> • HLV: <b>{selectedClass.coach?.fullName || 'Chưa gán'}</b></div>}
